@foreach ($examStructures as $item)
    <div class="modal fade modal-lg-edit{{ $item['exam_structure_id'] }}" id="modal-lg-edit" class="" style="display: none;" aria-hidden="true">
                    ...
                    <form id="quickForm" method="POST"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                {!! Form::text("exam_structure_name", $item['exam_structure_name'], ["class"=>"form-control", "id"=>"exampleInputEmail1",
                                "placeholder"=>""]) !!}
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Số lượng câu hỏi</label>
                                {!! Form::text("exam_structure_quantity", $item['exam_structure_quantity'], ["class"=>"form-control",
